...
module.exports = class VueEngine {
  ...
  async onPrepare() {
    const createAppData = createAppTemplate(this.api.enhanceAppFiles.files)
    await fs.writeFile(
      this.api.resolveDataDir('create-app.js'),
      createAppData,
      'utf8'
    )
  }
  ...
  async buildRouter() {
    ...
    await fs.writeFile(this.api.resolveDataDir('router.js'), routerData, 'utf8')
  }
